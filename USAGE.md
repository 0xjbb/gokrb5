...
```go
import "gopkg.in/0xjbb/gokrb5.v7/config"
...
```go
import 	"gopkg.in/0xjbb/gokrb5.v7/keytab"
...
```go
import 	"gopkg.in/0xjbb/gokrb5.v7/client"
...
```go
import 	"gopkg.in/0xjbb/gokrb5.v7/service"
